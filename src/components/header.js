  ...
  ">
      ...
      <div class="flex px-4 justify-between items-center w-full">
        ...
        <div class="relative text-gray-600 focus-within:text-gray-400">
          ...
          <input type="search" name="q" class="py-2 text-sm text-white border border-solid  border-yellow-300 rounded-md pl-10 focus:outline-none focus:bg-[#fcaf17]  focus:text-gray-900" placeholder="Search..." autocomplete="off">
        </div>
      </form>
        </div>
