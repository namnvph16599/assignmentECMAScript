              ...
              .map((val, ind) => {
                return /*html*/ `
                   <a href="/details/${val.id}" class="group">
                     ...
                     <img src="${val.image_url}" alt="Tall slender porcelain bottle with natural clay textured body and cork stopper." class="w-full h-full object-center object-cover group-hover:opacity-75">
                     </div>
