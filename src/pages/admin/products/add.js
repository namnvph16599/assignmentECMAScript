...
import { addProducts } from "../../../instance/products";
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
              <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div class="col-span-3">
                    ...
                    <div class="mt-1">
                      <input type="number" name="price" id="price" class="p-4 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-base border border-gray-300 rounded-md" placeholder="">
                    </div>
                  </div>
                <div>
